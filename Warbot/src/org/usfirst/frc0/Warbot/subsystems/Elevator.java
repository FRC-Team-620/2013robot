...
public class Elevator extends PIDSubsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        setDefaultCommand(new ElevateWithJoysticks());
    }
    ...
    public void moveElevator(double destAngle){
        getPIDController().setSetpoint(destAngle);
        getPIDController().enable();
    }
    public void stopElevator() {
        getPIDController().disable();
    }
    public void adjustElevator(double angle){
        getPIDController().setSetpoint(returnPIDInput()+angle);
        getPIDController().enable();
    }
}
